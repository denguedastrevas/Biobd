            ...
            <div class="bg-body-light">
                <div class="content content-full">
                    <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                        <h1 class="flex-sm-fill font-size-h2 font-w400 mt-2 mb-0 mb-sm-2">Banco</h1>
...
gf
                    ...
                    <div class="block-content">
                          ...
                          <nav class="menu">
                        <ul>
                        <li><a href="#">Vitis spp.</a>
                        <ul>
                        <li><a href="videira.php">transcriptoma </a></li>
                        <li><a href="#">Fator de transcrição</a>
                        <li><a href="#"> WRKY</a></li>
                        <li><a href="#">bZIP</a></li>
                        <li><a href="#">Fosfotransfesases</a></li>
                        <li><a href="#">Genes de resistência</a></li>
                        <li><a href="#">Proteínas relacionadas a patogênese</a></li>
                        </ul>
                        </li>
                          </nav>
                        </p>
