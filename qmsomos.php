        ...
        <nav id="sidebar" aria-label="Main Navigation">
            ...
            <div class="content-side content-side-full">
                ...
                <li class="nav-main-item">
                    ...
                    <li class="nav-main-item">
                        <a class="nav-main-link active" href="acessos.php">
                            <i class="nav-main-link-icon fa fa-rocket"></i>
                    ...
                    <li class="nav-main-item">
                        <a class="nav-main-link active" href="duvidas.php">
                            <i class="nav-main-link-icon fa fa-rocket"></i>
                    ...
                    <li class="nav-main-item">
                        <a class="nav-main-link active" href="sup.php">
                            <i class="nav-main-link-icon fa fa-rocket"></i>
            ...
            <div class="bg-body-light">
                <div class="content content-full">
                    <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                        <h1 class="flex-sm-fill font-size-h2 font-w400 mt-2 mb-0 mb-sm-2">Quem Somos</h1>
    ...
    width 300px;
            ...
            <div class="content">
                ...
                <div class="block block-rounded block-bordered">
                    ...
                    <div class="block-1" >
                        <div class="img">
                        <img src="img/ana.png" alt="some text" width=150 height=150>
            </div>    <div class="texto">

                      <p>  O Brazilian Grape Omics Consortium (BrGOC) é uma iniciativa coordenada pela Drª Ana Maria Benko Iseppon (UFPE) em colaboração com a Embrapa Semiárido que visou o desenvolvimento do transcriptoma da interação Vitis-Xanthomonas usando a cultivar suscetível 'Red Globe' (uma das mais cultivadas na região SVSF) e um genótipo híbrido tolerante IAC-572, a qual tem contribuído para a identificação, caracterização e classificação de várias famílias gênicas de interesse (Fatores de transcrição, Genes de resistência, Proteínas relacionadas a patogênese – PRs, Proteínas Quinases, entre outras) através de ferramentas de bioinformática bem como para a geração de perfis de expressão gênica diferencial (SILVA, 2018; ABURJAILE, 2019; OLIVEIRA, 2019). Etapas em andamento envolvem a seleção de genes candidatos para validação por RT-qPCR e posterior uso em eventos de transformação genética visando auxiliar programas de melhoramento genético da cultura. Além das bibliotecas de RNA-Seq geradas, foram sequenciados 60 acessos de Xanthomonas com características de patogenicidade distintas em parceria com a Universidade Federal de Minas Gerais - UFMG e a Universidade Federal Rural de Pernambuco - UFRPE, Universidade Federal Rural de Pernambuco), reforçando ainda mais o potencial dessa iniciativa para a geração de dados oriundos de diferentes ômicas (genômica e transcriptômica)
</p> 
